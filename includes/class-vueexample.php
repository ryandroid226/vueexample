...
class Vueexample {
	 ...
	 *
	 * - Vueexample_Loader. Orchestrates the hooks of the plugin.
	 * - Vueexample_i18n. Defines internationalization functionality.
	 * - Vueexample_Admin. Defines all hooks for the admin area.
	 * - Vueexample_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Vueexample_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
